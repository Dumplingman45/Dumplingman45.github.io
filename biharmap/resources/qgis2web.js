...
map.getView().fit([9236435.781452, 2759121.852418, 9863604.408426, 3227952.702968], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bihar Districts with High Risk for Flooding </h2>';
        return titleElement;
    })(),
